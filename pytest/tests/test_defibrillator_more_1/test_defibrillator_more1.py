...
* current directory is devsure *
    ...
    pytest devsure_demo/tests_demo/pytest/tests/test_defibrillator_more_1
        (to run all tests under the "test_defibrillator_more_1" directory)
    pytest devsure_demo/tests_demo/pytest/tests/test_defibrillator_more_1/test_defibrillator_more1.py
        (to run all tests from the "test_defibrillator_more1.py" test file)
