...
* current directory is devsure *
    ...
    pytest devsure_demo/tests_demo/pytest/tests/test_defibrillator_more_4
        (to run all tests under the "test_defibrillator_more_4" directory)
    pytest devsure_demo/tests_demo/pytest/tests/test_defibrillator_more_4/test_defibrillator_more4.py
        (to run all tests from the "test_defibrillator_more4.py" test file)
