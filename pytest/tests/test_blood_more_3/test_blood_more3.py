...
* current directory is devsure *
    ...
    pytest devsure_demo/tests_demo/pytest/tests/test_blood_more_3
        (to run all tests under the "test_blood_more_3" directory)
    pytest devsure_demo/tests_demo/pytest/tests/test_blood_more_3/test_blood_more3.py
        (to run all tests from the "test_blood_more3.py" test file)
