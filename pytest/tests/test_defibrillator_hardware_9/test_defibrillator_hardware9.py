...
* current directory is devsure *
    ...
    pytest devsure_demo/tests_demo/pytest/tests/test_defibrillator_hardware_9
        (to run all tests under the "test_defibrillator_hardware_9" directory)
    pytest devsure_demo/tests_demo/pytest/tests/test_defibrillator_hardware_9/test_defibrillator_hardware9.py
        (to run all tests from the "test_defibrillator_hardware9.py" test file)
