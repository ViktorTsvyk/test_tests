...
* current directory is devsure *
    ...
    pytest devsure_demo/tests_demo/pytest/tests/test_defibrillator_hardware_8
        (to run all tests under the "test_defibrillator_hardware_8" directory)
    pytest devsure_demo/tests_demo/pytest/tests/test_defibrillator_hardware_8/test_defibrillator_hardware8.py
        (to run all tests from the "test_defibrillator_hardware8.py" test file)
