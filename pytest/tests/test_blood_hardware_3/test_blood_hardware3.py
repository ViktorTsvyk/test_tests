...
* current directory is devsure *
    ...
    pytest devsure_demo/tests_demo/pytest/tests/test_blood_hardware3
        (to run all tests under the "test_blood_hardware3" directory)
    pytest devsure_demo/tests_demo/pytest/tests/test_blood_hardware_3/test_blood_hardware3.py
        (to run all tests from the "test_blood_hardware3.py" test file)
