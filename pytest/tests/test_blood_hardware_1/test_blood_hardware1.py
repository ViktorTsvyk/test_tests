...
* current directory is devsure *
    ...
    pytest devsure_demo/tests_demo/pytest/tests/test_blood_hardware_1
        (to run all tests under the "test_blood_hardware_1" directory)
    pytest devsure_demo/tests_demo/pytest/tests/test_blood_hardware_1/test_blood_hardware1.py
        (to run all tests from the "test_blood_hardware1.py" test file)
