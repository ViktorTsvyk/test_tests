...
* current directory is devsure *
    ...
    pytest devsure_demo/tests_demo/pytest/tests/test_blood_hardware4
        (to run all tests under the "test_blood_hardware4" directory)
    pytest devsure_demo/tests_demo/pytest/tests/test_blood_hardware_4/test_blood_hardware4.py
        (to run all tests from the "test_blood_hardware4.py" test file)
