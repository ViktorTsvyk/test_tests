...
* current directory is devsure *
    ...
    pytest devsure_demo/tests_demo/pytest/tests/test_blood_more_2
        (to run all tests under the "test_blood_more_2" directory)
    pytest devsure_demo/tests_demo/pytest/tests/test_blood_more_2/test_blood_more2.py
        (to run all tests from the "test_blood_more2.py" test file)
