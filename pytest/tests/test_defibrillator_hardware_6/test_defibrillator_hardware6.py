...
* current directory is devsure *
    ...
    pytest devsure_demo/tests_demo/pytest/tests/test_defibrillator_hardware_6
        (to run all tests under the "test_defibrillator_hardware_6" directory)
    pytest devsure_demo/tests_demo/pytest/tests/test_defibrillator_hardware_6/test_defibrillator_hardware6.py
        (to run all tests from the "test_defibrillator_hardware6.py" test file)
