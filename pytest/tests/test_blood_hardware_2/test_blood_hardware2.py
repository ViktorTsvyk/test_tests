...
* current directory is devsure *
    ...
    pytest devsure_demo/tests_demo/pytest/tests/test_blood_hardware_2
        (to run all tests under the "test_our_model_2" directory)
    pytest devsure_demo/tests_demo/pytest/tests/test_blood_hardware_2/test_blood_hardware2.py
        (to run all tests from the "test_blood_hardware2.py" test file)
