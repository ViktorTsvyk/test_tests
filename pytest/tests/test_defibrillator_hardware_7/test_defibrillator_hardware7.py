...
* current directory is devsure *
    ...
    pytest devsure_demo/tests_demo/pytest/tests/test_defibrillator_hardware_7
        (to run all tests under the "test_defibrillator_hardware_7" directory)
    pytest devsure_demo/tests_demo/pytest/tests/test_defibrillator_hardware_7/test_defibrillator_hardware7.py
        (to run all tests from the "test_defibrillator_hardware7.py" test file)
