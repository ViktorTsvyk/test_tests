...
* current directory is devsure *
    ...
    pytest devsure_demo/tests_demo/pytest/tests/test_blood_hardware_5
        (to run all tests under the "test_blood_hardware_5" directory)
    pytest devsure_demo/tests_demo/pytest/tests/test_blood_hardware_5/test_blood_hardware5.py
        (to run all tests from the "test_blood_hardware5.py" test file)
