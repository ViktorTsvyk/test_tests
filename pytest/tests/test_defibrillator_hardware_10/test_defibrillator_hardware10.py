...
* current directory is devsure *
    ...
    pytest devsure_demo/tests_demo/pytest/tests/test_defibrillator_hardware_10
        (to run all tests under the "test_defibrillator_hardware_10" directory)
    pytest devsure_demo/tests_demo/pytest/tests/test_defibrillator_hardware_10/test_defibrillator_hardware10.py
        (to run all tests from the "test_defibrillator_hardware10.py" test file)
